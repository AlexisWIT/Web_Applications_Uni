...
<head>
	...
	<title>Members | Genealogy Explorer</title>
	
	<!-- Index css -->
	<link href="<core:url value="resources/css/index.css" />" rel="stylesheet" type="text/css" />
	...
	<div class="main-container">
		<div class="inner">
			...
			<ul class="nav nav-bar-list">
				<li><a href="/">Home</a></li>
				<li class="active"><a href="/GE/person">Member</a></li>
